...
public class DiggingLeadscrew extends SubsystemBase {
    ...
    public LeadscrewStatus leadscrewStatus;
    ...
    private void createDashboardData() {
        shuffleboardEntries.put("screw-init", Shuffleboard.getTab("Jared-Malin").add("Screw Init", leadscrewInitialized).withSize(1, 1).withPosition(5, 0).getEntry());
        shuffleboardEntries.put("screw-state", Shuffleboard.getTab("Jared-Malin").add("Screw State", leadscrewState.toString()).withSize(1, 1).withPosition(5, 1).getEntry());
        shuffleboardEntries.put("limit-top-Right", Shuffleboard.getTab("Jared-Malin").add("Screw Top SW Right", l_leadscrew1Top.isPressed()).withSize(1, 1).withPosition(3, 2).getEntry());
        shuffleboardEntries.put("limit-top-Left", Shuffleboard.getTab("Jared-Malin").add("Screw Top SW Left", l_leadscrew2Top.isPressed()).withSize(1, 1).withPosition(2, 2).getEntry());
        shuffleboardEntries.put("limit-Bottom-Right", Shuffleboard.getTab("Jared-Malin").add("Screw Bottom SW Right", l_leadscrew1Bottom.isPressed()).withSize(1, 1).withPosition(3, 3).getEntry());
        shuffleboardEntries.put("limit-Bottom-Left", Shuffleboard.getTab("Jared-Malin").add("Screw Bottom SW Left", l_leadscrew2Bottom.isPressed()).withSize(1, 1).withPosition(2, 3).getEntry());
        shuffleboardEntries.put("screw-position-Right", Shuffleboard.getTab("Jared-Malin").add("Screw Position-Right", 0).withSize(1, 1).withPosition(3, 0).getEntry());
        shuffleboardEntries.put("screw-position-Left", Shuffleboard.getTab("Jared-Malin").add("Screw Position-Left", 0).withSize(1, 1).withPosition(2, 0).getEntry());
        shuffleboardEntries.put("screw-speed-Right", Shuffleboard.getTab("Jared-Malin").add("Screw Speed Right", 0).withSize(1, 1).withPosition(3, 1).getEntry());
        shuffleboardEntries.put("screw-speed-Left", Shuffleboard.getTab("Jared-Malin").add("Screw Speed Left", 0).withSize(1, 1).withPosition(2, 1).getEntry());
        ...
        // shuffleboardEntries.put("Leadscrewmotor-temperature-Right", Shuffleboard.getTab("Jared-Malin").add("Leader Temperature", m_leadscrew1.getMotorTemperature() + " C").withSize(1,1).withPosition(9,4).getEntry());
        // shuffleboardEntries.put("Leadscrewmotor-temperature-Left", Shuffleboard.getTab("Jared-Malin").add("Follower Temperature", m_leadscrew2.getMotorTemperature() + " C").withSize(1,1).withPosition(10,4).getEntry());
        }
    ...
    private void reportSensors() {
        ...
        shuffleboardEntries.get("screw-position-Right").setDouble(LunaMathUtils.roundToPlace(Math.abs(e_leadscrew.getPosition()), 3));
        shuffleboardEntries.get("screw-position-Left").setDouble(LunaMathUtils.roundToPlace(Math.abs(e_leadscrew2.getPosition()), 3));
        shuffleboardEntries.get("screw-speed-Right").setDouble(LunaMathUtils.roundToPlace(e_leadscrew.getVelocity(), 3));
        shuffleboardEntries.get("screw-speed-Left").setDouble(LunaMathUtils.roundToPlace(e_leadscrew2.getVelocity(), 3));
        ...
        // Limit Switches
        shuffleboardEntries.get("limit-top-Right").setBoolean(l_leadscrew1Top.isPressed());
        shuffleboardEntries.get("limit-top-Left").setBoolean(l_leadscrew2Top.isPressed());
        shuffleboardEntries.get("limit-Bottom-Right").setBoolean(l_leadscrew1Bottom.isPressed());
        shuffleboardEntries.get("limit-Bottom-Left").setBoolean(l_leadscrew2Bottom.isPressed());
        ...
        networkTable.getEntry("leadscrewPositionRight").setDouble(Math.abs(e_leadscrew.getPosition()));
        networkTable.getEntry("leadscrewPositionLeft").setDouble(Math.abs(e_leadscrew2.getPosition()));
        ...
        // shuffleboardEntries.get("Leadscrewmotor-temperature-Right").setString(""+LunaMathUtils.roundToPlace(m_leadscrew1.getMotorTemperature(), 5));
        // shuffleboardEntries.get("Leadscrewmotor-temperature-Left").setString(""+LunaMathUtils.roundToPlace(m_leadscrew2.getMotorTemperature(), 5));
